...
public class gLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__9", "T__10", "INDENT", "DEDENT", "TAB", "NUM", "INT", "FLOAT", "BOOL", 
			"STRING", "SINGLE_LINE_COMMENT", "MULTI_LINE_COMMENT", "COLON", "FOR", 
			"PLUS", "MINUS", "MULTIPLY", "DIVIDE", "MOD", "ASSIGN", "PLUS_EQUAL", 
			"MINUS_EQUAL", "MULTI_EQUAL", "DIVIDE_EQUAL", "MOD_EQUAL", "EQUAL_EQUAL", 
			"DOESNOT_EQUAL", "LESS_THAN", "LESS_THAN_EQUAL", "GREATER_THAN", "GREATER_THAN_EQUAL", 
